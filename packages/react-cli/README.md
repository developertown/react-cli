...
@developertown/react-cli/0.3.0 linux-x64 node-v8.15.1
$ react --help [COMMAND]
USAGE
  $ react COMMAND
...
...
_See code: [src/commands/generate.ts](https://github.com/developertown/react-cli/blob/v0.3.0/src/commands/generate.ts)_
...
_See code: [src/commands/new.ts](https://github.com/developertown/react-cli/blob/v0.3.0/src/commands/new.ts)_
<!-- commandsstop -->
